...
TEST_CASE("Getting and classifying an image") {
  ...
  SECTION("Classifying Images") {
    naivebayes::TrainingSet trainingSet(p_finder);
    trainingSet.ReadTestingLabel("mnistdatavalidation/testlabels");
    std::ifstream ifstream_images_s;
    ifstream_images_s.open("mnistdatavalidation/testimages");

    /*while (ifstream_images_s.good()) {
      ifstream_images_s >> trainingSet;
    }*/
